...
document.querySelector(".uploadScore").addEventListener("click",function(){
...
function uploadScore(){
    console.log('upload de score')
        ...
        const asyncFunc1 = async () =>{
            ...
            const wait = await fetch('https://gitgame.avkaransarminder.ikdoeict.be/scores_all', {
                method: "POST",
                headers: {        
            ...
            if (wait.ok){
                ...
                if (content.status === 'succes'){
                    document.location.href = "./../contact_and_leaderboards/leaderboard/" 
                }
            }else{
